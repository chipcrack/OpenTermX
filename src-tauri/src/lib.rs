...
pub fn run() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::workspace_transfer::export_workspace_data,
      commands::workspace_transfer::export_workspace_data_to_file,
      commands::workspace_transfer::import_workspace_data,
